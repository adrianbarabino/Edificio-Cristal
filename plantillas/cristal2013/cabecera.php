...
marcador_oficinas.events.register('mouseout', marcador_oficinas, function(evt) {     setTimeout( function() { }, 10000)});
		...
		//    var popup = new OpenLayers.Popup.FramedCloud("Cristal 1",
		//                    marcador_cristal_1.lonlat,
		//                    null,
		//                    "<i class='icon-building'></i>&nbsp;Edificio Cristal 1<br><i class='icon-map-marker'></i>&nbsp; Avenida Roca 1142",
		//                    null, true);

		// map.addPopup(popup);

		//    var popup2 = new OpenLayers.Popup.FramedCloud("Cristal 2",
		//                    marcador_cristal_2.lonlat,
		//                    null,
		//                    "<i class='icon-building'></i>&nbsp;Edificio Cristal 2<br><i class='icon-map-marker'></i>&nbsp;Rivadavia y Roca",
		//                    null, true);

		// map.addPopup(popup2);

		//    var popup3 = new OpenLayers.Popup.FramedCloud("Oficinas",
		//                    marcador_oficinas.lonlat,
		//                    null,
		//                    "<i class='icon-building'></i>&nbsp;Oficinas<br><i class='icon-map-marker'></i>&nbsp;Maipú y Tucumán<br><i class='icon-phone'></i>&nbsp;02966-432397 / 434889",
		//                    null, true);
